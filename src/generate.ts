...
const getHue = (hsv: HsvObject, i: number, light?: boolean): number => {
	let hue: number;
...
const getSaturation = (hsv: HsvObject, i: number, light?: boolean): number => {
...
const getValue = (hsv: HsvObject, i: number, light?: boolean): number => {
	let value: number;
	if (light) {
...
const generate = (color: string, opts: Opts = {}): string[] => {
